...
import cio.android.dagger2demo.Strings;
...
public class NewTaskFragment extends BaseFragment {
    ...
    @BindView(R.id.new_task_add) Button actionButton;
    @BindView(R.id.new_task_task_name) EditText taskName;
    @BindView(R.id.new_task_task_desc) EditText taskDesc;
    @BindView(R.id.new_task_task_name_input_layout) TextInputLayout nameInputLayout;
